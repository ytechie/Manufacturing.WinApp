...
namespace Manufacturing.WinApp.Views.UserManagment
{
    ...
    public sealed partial class UserListPage : Page
    {
        ...
        private UserListViewModel defaultViewModel = new UserListViewModel();
        ...
        public void EditorAccepted(object sender, AcceptedEditorEventArgs args)
        {
            defaultViewModel.EditUserCommit();
        }
    }
}
